      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted max-w-xl mx-auto leading-relaxed text-pretty">
            Três opções de acesso ao congresso. Escolha a que melhor se adequa
            ao seu perfil.
          </p>
        </div>
          ...
          {eventOffers.map((option, index) =>
            (() => {
              ...
              return (
                ...
                >
                  {soldOut ? (
                    <div className="absolute left-6 top-2 inline-flex items-center rounded-full border border-[#9CA3AF] bg-[#d6dce2] px-3 py-1 text-[11px] font-bold uppercase tracking-[0.24em] text-[#4B5563]">
                      Esgotado
                    </div>
                  ) : null}
                  ...
                  {/* Content */}
                  <div
                    className={`p-8 sm:p-10 flex flex-col h-full ${option.featured ? "pt-12" : ""}`}
                  >
                    {/* Title */}
                    <h3
                      className={`text-lg sm:text-xl font-bold uppercase tracking-[0.05em] ${
                        soldOut
                          ? "text-[#5f6b76] line-through decoration-2 decoration-[#5f6b76]/80"
                          : "text-[#1a1a1a]"
                      }`}
                    >
                      {option.title}
